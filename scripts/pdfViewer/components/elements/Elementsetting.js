...
const Elementsetting_1= {
    ...
    create : function(){
        ...
        let header_height = window.innerWidth > window.innerHeight?  15/100 * this.height: 15/100 *this.height;
        ...
        console.log(side_nav_main_width + "side width")
        ...
        // let min_dropdown_width = 7 /100 * 1366 //most computer resolution width
    ...
    set : function(){
        ...
        // this.dropdown.style.minWidth = this.min_dropdown_width;
...
const Elementsetting_2= {
    ...
    create : function(){
        ...
        let header_height = 15/100 * this.height;
